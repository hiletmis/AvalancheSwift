...
public final class AvalanchePrivateKey {
    ...
    /**
     * Initializes a new cryptographically secure `AvalanchePrivateKey` from random noise.
     *
...
extension AvalanchePrivateKey: Equatable {

    public static func ==(_ lhs: AvalanchePrivateKey, _ rhs: AvalanchePrivateKey) -> Bool {
...
extension AvalanchePrivateKey: Hashable {
